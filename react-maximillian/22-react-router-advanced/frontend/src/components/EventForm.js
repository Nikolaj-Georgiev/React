...
function EventForm({ method, event }) {
  ...
  return (
    // <Form method='post' action='/any-other-path' className={classes.form}> // with this if you have any other action specified in the rout you can trigger the action to that form by specifying the path to that action 
